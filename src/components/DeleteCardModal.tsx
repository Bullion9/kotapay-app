...
const DeleteCardModal: React.FC<DeleteCardModalProps> = ({
  ...
  React.useEffect(() => {
    console.log('Text:', confirmationText, 'Valid:', isConfirmationValid);
        ...
        >
          ...
          <View style={styles.cardPreview}>
            <View style={[styles.cardGradient, { backgroundColor: cardGradient.colors[0] }]}>
              <View style={styles.cardBlurOverlay}>
                {/* Card Lines - Top Right */}
                <View style={styles.cardLines}>
                  <View style={[styles.cardLine, styles.cardLineTop]} />
                  <View style={[styles.cardLine, styles.cardLineMiddle]} />
                  <View style={[styles.cardLine, styles.cardLineBottom]} />
                </View>
                
                {/* Card Lines - Bottom Left */}
                <View style={styles.cardLinesBottom}>
                  <View style={[styles.cardLine, styles.cardLineBottomFirst]} />
                  <View style={[styles.cardLine, styles.cardLineBottomSecond]} />
                </View>
          ...
          <View style={styles.confirmationSection}>
            ...
            <TextInput
              ...
              style={[
                ...
                isInputFocused && styles.confirmationInputFocused,
          ...
          <View style={styles.actionButtons}>
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                console.log('Button pressed, validation:', isConfirmationValid);
                if (isConfirmationValid) {
                  console.log('Validation passed, calling onPinRequired');
            ...
            >
              <Text style={[
                ...
                !isConfirmationValid && styles.deleteButtonTextDisabled,
              ]}>Delete Forever</Text>
            </TouchableOpacity>
          </View>
          </ScrollView>
