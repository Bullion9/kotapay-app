...
const HomeScreen: React.FC = () => {
  ...
  const quickActions = [
    ...
    },
    {
      ...
      icon: Plus,
      color: colors.accent,
      onPress: () => {/* Add Top Up functionality */},
    },
    {
      title: 'Cash Out',
      icon: Minus,
      color: colors.error,
      onPress: () => {/* Add Cash Out functionality */},
    },
    {
      title: 'Bills',
      icon: FileText,
      color: colors.seaGreen,
      onPress: () => {/* Add Bills functionality */},
    },
  ];
  ...
  return (
    <SafeAreaView style={styles.container}>
        ...
        <View style={styles.header}>
          ...
          <View style={styles.headerRight}>
            <TouchableOpacity style={styles.iconButton}>
              <Mail size={iconSizes.md} color={colors.text} />
            </TouchableOpacity>
            <NotificationMailIcon unreadCount={4} />
          </View>
        </View>
      ...
      <TouchableOpacity 
        ...
        onPress={() => navigation.navigate('SendMoney', {})}
      >
        <Send size={iconSizes.md} color={colors.white} />
      </TouchableOpacity>
    </SafeAreaView>
  );
};
